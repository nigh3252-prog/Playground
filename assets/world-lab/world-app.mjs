...
function actualMode(){return mode==='basins'&&stage<2||mode==='rainfall'&&stage<3?'natural':mode;}
function paint(){
...
function showStage(value){
  stage=clamp(value|0,1,3);pendingStage=stage;document.querySelectorAll('[data-stage]').forEach(b=>b.setAttribute('aria-pressed',String(Number(b.dataset.stage)===stage)));
