 ...
 *
 * The benchmark sources are captured into versioned repo snapshots. Normal
 * app/deployment builds NEVER call these URLs; only the manual freeze workflow
 * does. This keeps scores comparable across code changes and makes previews
 * independent of upstream service availability.
 */
export const PROTOCOL=Object.freeze({version:'watershed-benchmark-2-frozen',waterDataset:'USGS NHD high-resolution waterbody snapshot',riverDataset:'Natural Earth 10m rivers/lake-centerlines snapshot',populationDataset:'US Census 2020 tract population snapshot at representative points',historicalDataset:'Census 1850 largest-100 urban-place snapshot',evaluationN:257,minimumLakeKm2:25,riverDrainageKm2:500,riverToleranceKm:10,edgeBufferKm:25,parameterProfile:'water-budget-r5-unfitted',climatePeriod:'1991-2020',noAutomaticFitting:true,frozenSnapshots:true});
