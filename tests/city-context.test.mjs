...
import {regionalCityContext} from '../assets/world-lab/city-context.mjs';
...
test('local context retains exact parent connections and river geometry at the selected date',()=>{
 ...
 const frame={year:50,generation:2,siteStates:[{siteId:0,population:5000,urbanAreaKm2:3},{siteId:1,population:9000,urbanAreaKm2:6},{siteId:2,population:1200}],routeStates:[{routeId:0,active:true},{routeId:1,active:true}]};
