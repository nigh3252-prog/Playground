...
for(const file of ['assets/world-lab/world-app-v6.mjs','assets/world-lab/world-worker-v6.mjs','assets/local-terrain/local-terrain-app.mjs']){const module=await get(file);if(module.status==='unlinked')await module.link(linker);console.log('Linked browser module graph:',file);}
