...
const manifest=JSON.parse(await readFile('assets/world-lab/benchmarks/manifest.json','utf8'));
const reports=[];
for(const id of Object.keys(BENCHMARK_REGIONS)){
 ...
 report.generatedAt=manifest.capturedAt;
...
await writeFile('assets/world-lab/benchmarks/baseline-reports.json',JSON.stringify({protocol:PROTOCOL,created:manifest.capturedAt,reports},null,2));
